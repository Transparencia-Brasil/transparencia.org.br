function registrarPageView(e) {
    ga && ga("send", "pageview", "/" + e)
}

function registrarEvento(e, o, r) {
    ga && ga("send", "event", e, o, r)
}

function abrirModal(e, o, r, a) {
    $("#modal-texto").text(""), $("#modal-conteudo").text(""), 0 == e.length ? $("#modal-titulo").hide() : ($("#modal-titulo").show(), $("#modal-titulo").html(e)), $("#modal-texto").html(o), null != r && null != a && $("#modal-conteudo").append('<a href="' + a + '">' + r + "</a>"), $(".overlay").fadeIn(400, function() {
        $(".bx-modal").fadeIn(400)
    })
}

function abrirDoacao() {
    $("body").append('<form action="https://pagseguro.uol.com.br/checkout/v2/donation.html" id="formDoacaoPost" target="_blank" style="display:none" method="post"><input type="hidden" name="currency" value="BRL" /><input type="hidden" name="receiverEmail" value="doacoes@transparencia.org.br" /></form>'), $("#formDoacaoPost").submit()
}
var FrontEnd = {
    Init: function() {
        this.Events()
    ...
    Events: function() {
        0 !== $(document).find(".bxslider").length && $(".bxslider").bxSlider({
            video: !0,
            useCSS: !0,
            adaptiveHeight: !0,
            mode: "horizontal",
            slideWidth: 1280,
            onSlideNext: function(e, o, r) {
                registrarEvento("destaque_principal_setas", "clique", "para_frente")
            },
            onSlidePrev: function(e, o, r) {
            ...
            var o = $(window).scrollTop(),
                r = $(".wr-header"),
                a = $(".wr-header").height();
            if (o >= 1.5 * a ? r.addClass("fixed") : r.removeClass("fixed"), 0 !== $(document).find(".pg-home .ct-carousel").length) {
                o >= a & o <= $(".ct-carousel").height() - 6 * a ? r.addClass("hidden") : r.removeClass("hidden")
            } else o >= a & o <= 1.5 * a ? r.addClass("hidden") : r.removeClass("hidden")
...
var SPMaskBehavior = function(e) {
    ...
    spOptions = {
        onKeyPress: function(e, o, r, a) {
            r.mask(SPMaskBehavior.apply({}, arguments), a)
        }
    };
$(document).ready(function() {
    $("#estrangeiro").change(function() {
        ...
        messages: {
            ...
            CelularDDD: {
                required: msgsGenericas.campoObrigatorio,
                minlength: "O ddd do celular digitado deve ter 2 dígitos.",
                maxlength: "O ddd do celular digitado deve ter 2 dígitos."
            },
            Celular: {
                required: msgsGenericas.campoObrigatorio,
