  ...
  a.extend(a.fn, { validate: function (b) {
    ...
    return 1 === arguments.length ? function () {
      ...
      a.extend(a.validator.defaults, b);
        ...
        if (b) {
          a.extend(this.errorMap, b), this.errorList = [];for (var c in b) this.errorList.push({ message: b[c], element: this.findByName(c)[0] });this.successList = a.grep(this.successList, function (a) {
            return !(a.name in b);
          });
        ...
        for (var a = 0; a < arguments.length; a++) if (void 0 !== arguments[a]) return arguments[a];return void 0;
      ...
      var c,
          ...
          e = {},
          f = a(b),
          g = b.getAttribute('type');for (c in a.validator.methods) 'required' === c ? (d = b.getAttribute(c), '' === d && (d = !0), d = !!d) : d = f.attr(c), /min|max/.test(c) && (null === g || /number|range|text/.test(g)) && (d = Number(d)), d || 0 === d ? e[c] = d : g === c && 'range' !== g && (e[c] = !0);return e.maxlength && /-1|2147483647|524288/.test(e.maxlength) && delete e.maxlength, e;
