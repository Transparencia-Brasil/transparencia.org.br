<!-- 1 tela -->
<div id ='obra' class="container content-box">
  <div class="tadepe-page npadtop">
...
<div class="ot_caixa" ><p class="ot_p">Fruto de uma parceria entre a Transparência Brasil e o <a class="ot_link" title="Observatório Social do Brasil (OSB)" target="_blank" href="http://osbrasil.org.br/">Observatório Social do Brasil (OSB)</a>, o Obra Transparente teve sua primeira edição financiada pelo <a class="ot_link" title="Fundo de Democracia das Nações Unidas (United Nations Democracy Fund – UNDEF)" target="_blank" href="https://www.un.org/democracyfund/">Fundo de Democracia das Nações Unidas (United Nations Democracy Fund – UNDEF)</a> entre maio de 2017 e junho de 2019, e reuniu observatórios sociais locais atuantes em 21 municípios das regiões Sul e Sudeste do país.<br>O projeto fortaleceu o controle social de obras públicas realizado pelos observatórios sociais participantes por meio de:</p>

<ol class="ot_ol_main"><li><b class="ot_beta">1</b> Treinamentos para o monitoramento de obras públicas;</li>
<li><b class="ot_beta">2</b> Assessoria técnica aos observatórios;</li>
...
<div class="ot_caixa"> <div class="ot_bigenvelope"><br>
       <div class="ot_bigacordion"> <img class="ot_img" src="   _imagem_   " title="">
      
      
       
           Estrutura 
      </div>
      <div class="ot_bigtxtdrop">
            <div class="ot_envelope"><br>
                  

      <div class="ot_acordion">
            
            O que é o projeto Obra Transparente? </div>
                <div class="ot_txtdrop"> <p class="ot_p">Fruto de uma parceria entre a Transparência Brasil e o Observatório Social do Brasil (OSB), a primeira edição do projeto Obra Transparente formou uma rede de 21 Observatórios Sociais (OS) que recebeu treinamento e apoio técnico para o monitoramento de obras de escolas e creches financiadas pelo governo federal em seus municípios. As atividades foram realizadas entre maio de 2017 a julho de 2019, monitorando 135 obras no total.</p>
                </div>
                <!--nova pergunta -->
                <div class="ot_acordion">
            
            Quais foram as atividades do projeto? </div>
                <div class="ot_txtdrop"> <p class="ot_p">As atividades desenvolvidas buscaram fortalecer a atuação dos OS por meio de capacitações, assessoria técnica e compartilhamento de experiências e boas práticas para o monitoramento de obras públicas. <br>As capacitações incluíram treinamentos online e presenciais em três módulos:</p>
                   <ol class="ot_ol">
                    <li> editais de obras públicas;</li>
                    <li> execução de obras públicas; e </li>
                    <li> análise de risco de fraude e corrupção em contratações públicas. </li></ol>
                <p class="ot_p">Com base nas capacitações, os participantes monitoraram documentos e obras <i>in loco</i>. Ao constatarem atrasos e possíveis irregularidades, os Observatórios Sociais locais documentavam os achados e encaminhavam à Câmara Técnica do programa para análise das evidências coletadas. Se constatados problemas, prefeituras e os órgãos de controle eram acionados.</p>
                </div>
                <!--nova pergunta -->
                <div class="ot_acordion">
            
            Que análises foram realizadas pela Câmara Técnica?</div>
                <div class="ot_txtdrop"> <p class="ot_p">A Câmara Técnica foi composta por engenheiros e assessores jurídicos que prestaram assessoria técnica para integrantes dos OS na análise de editais e documentos relacionados à execução das obras monitoradas.</p>
                </div>
                <!--nova pergunta -->
                <div class="ot_acordion">
            
            Eu posso enviar um projeto para que a Câmara Técnica análise? </div>
                <div class="ot_txtdrop"> <p class="ot_p">As atividades de assessoria direta da Câmara Técnica estiveram disponíveis apenas para os OS participantes do projeto. Contudo, as análises produzidas pelos especialistas da Câmara Técnica estão disponíveis <a class="ot_link" title="análises produzidas pelos especialistas da Câmara Técnica" target="_blank" href="https://www.transparencia.org.br/blog/analises-tecnicas-de-projetos/">aqui</a>.</p>
                </div>

                <!--nova pergunta / trocar pelo diagnóstico -->
                <div class="ot_acordion">
      ...
      <div class="ot_bigacordion">
        <img class="ot_img" src="   _imagem_   " title="">
      ...
      <div class="ot_bigtxtdrop">
            ...
            Quais as causas para tantas obras não entregues?</div>
                <div class="ot_txtdrop"> <p class="ot_p">São muitas as causas encontradas pelos participantes. De forma resumida, os problemas observados no nível dos municípios para o fracasso das construções são:</p>
                  <ol class="ot_ol" ><li>falhas no planejamento das obras;</li>
                    <li>inadequações na formulação dos editais licitatórios;</li>
            ...
            Por que só são monitoradas obras de escolas e creches? </div>
                <div class="ot_txtdrop"> <p class="ot_p">A estratégia de atuação do projeto Obra Transparente consistia na colaboração entre organizações de escopo nacional e local, buscando desenvolver mecanismos para agir em rede de modo a influenciar a implementação de políticas públicas em diferentes níveis de governo. <br>Para testar essa estratégia, o projeto foi implementado em formato piloto, com um número reduzido de organizações locais e com enfoque somente em uma área de políticas públicas. A experiência adquirida nessa fase está documentada em relatórios, e permite expandir o foco do projeto para outros tipos de obras em projetos futuros.</p>
                </div>
                 <!--nova pergunta tem erro aqui-->
                <div class="ot_acordion">
            
            O conteúdo dos treinamentos <br>está disponível para o público? </div>
                <div class="ot_txtdrop"> <p class="ot_p">Os materiais impressos utilizados nos treinamentos oferecidos para as equipes das organizações participantes do projeto estão disponíveis na seção de publicações desta página. Já o conteúdo dos cursos à distância foi preparado em formato que conta com monitoria e está desativado no momento, sem previsão para novas edições. Acompanhe as nossas atividades para saber de novidades a respeito dos cursos.</p>
                </div>
                <!--nova pergunta -->
                <div class="ot_acordion">
      ...
      <div class="ot_bigtxtdrop">
            ...
            Quais foram os parceiros do projeto Obra Transparente? </div>
                <div class="ot_txtdrop"> <p class="ot_p"> O projeto foi realizado em parceria com o Observatório Social do Brasil (OSB), uma organização que realiza atividades de controle social e está presente em 19 estados brasileiros e se estende por mais de 100 cidades. Foram selecionados observatórios de 21 municípios, levando-se em conta o número de obras de escolas e creches financiadas pelo governo federal. Além do OSB, também foram parceiros do projeto, oferecendo apoio técnico e infraestrutura para as formações, a <a class="ot_link" title="Controladoria Geral da União" target="_blank" href="http://www.cgu.gov.br/">Controladoria-Geral da União (CGU)</a> e o <a class="ot_link" title="Conselho de Arquitetura e Urbanismo de Santa Catarina (CAU - SC)" target="_blank" href="http://www.causc.gov.br/">Conselho de Arquitetura e Urbanismo de Santa Catarina (CAU - SC)</a>.</p>
                </div>
                <!--nova pergunta -->
                <div class="ot_acordion">
            
            O que é o Observatório Social do Brasil (OSB)?</div>
                <div class="ot_txtdrop"> <p class="ot_p">O OSB capacita e coordena uma rede de observatórios sociais (OS), focada em monitorar a entrega de serviços públicos locais.<br> Os OS desenvolvem atividades de controle social com a proposta de promoverem espaços democráticos, apartidários e com o objetivo de atuar em conjunto com outras organizações para a melhoria do setor público.<br>Se não houver um observatório na sua cidade, você pode converir  <a class="ot_link" title="Como construir um Observatório Social" target="_blank" href="http://osbrasil.org.br/como-constituir-um-os/">aqui</a> como construir um.</p>
                </div>
<!--nova pergunta -->
                <div class="ot_acordion">
            
            Quais foram selecionados os observatórios participantes da 1ª edição do projeto? </div>
                <div class="ot_txtdrop"> <p class="ot_p">Para a seleção dos 21 observatórios participantes da primeira edição do projeto, foram observados o número de obras de escolas e creches financiadas pelo governo federal nos municípios integrantes da rede OSB, com um enfoque maior nas regiões Sul e Sudeste, onde a articulação dos observatórios é mais consolidada, de modo a facilitar as atividades da rede do projeto.</p>
                <p class="ot_p"> Confira abaixo a lista de Observatórios selecionados:
                  <p class="ot_p"> <ul class="ot_ol">
                    <li>Observatório Social de Araucária - PR</li>
                    <li>Observatório Social de Caçador - SC</li>
                    <li>Observatório Social de Campo Mourão - PR</li>
                    <li>Observatório Social de Cascavel - PR</li>
                    <li>Observatório Social de Chapecó - SC</li>
                    <li>Observatório Social de Foz do Iguaçu - PR</li>
                    <li>Observatório Social de Goioerê - PR</li>
                    <li>Observatório Social de Gravataí - RS</li>
                    <li>Observatório Social de Imbituba - SC</li>
                    <li>Observatório Social de Lajeado - RS</li>
                    <li>Observatório Social de Limeira - SP</li>
                    <li>Observatório Social de Palhoça - SC</li>
                    <li>Observatório Social de Paranaguá - PR</li>
                    <li>Observatório Social de Pelotas - RS</li>
                    <li>Observatório Social de Ponta Grossa - PR</li>
                    <li>Observatório Social de Santa Maria - RS</li>
                    <li>Observatório Social de São Francisco do Sul - SC</li>
                    <li>Observatório Social de São José dos Campos - SP</li>
                    <li>Observatório Social de Taubaté - SP</li>
                    <li>Observatório Social de Uberlândia - MG</li>
                    </ul>
                </p>
                </div>
...
<!--nova pergunta -->
            ...
            Por que o projeto não foi implementado também em outros municípios?</div>
                <div class="ot_txtdrop"> <p class="ot_p">O projeto foi implementado em formato piloto com um número restrito de observatórios e municípios. A experiência adquirida nessa fase gerou materiais e referências que outros municípios podem usar para desenvolver suas próprias atividades de monitoramento. <br>Há iniciativas independentes, como a do Observatório de Jequié (BA) que está implementando autonomamente a metodologia do projeto. Estamos em busca de novos financiamentos para continuar a aumentar a rede e implementar o projeto em outros municípios do país.</p>
                </div>
				</div>
            </div> 
        </div>
...
<!--publicações-->
 <h4 class="ot_sessao">Publicações</h4>


<div class="ot_bigenvelope"><br>
  ...
  <div class="ot_acordion">
                      <!--img class="ot_img" src="https://image.flaticon.com/icons/svg/35/35920.svg" title="Proinfância ou Problema na Infância? Os desafios na construção de creches e escolas em municípios brasileiros (2019)"-->
  ...
  <div class="ot_acordion">
                      <!--img class="ot_img" src="https://image.flaticon.com/icons/svg/35/35920.svg" title="Resultados positivos para avaliação qualitativa (2019)"-->
  ...
  <div class="ot_acordion">
                      <!--img class="ot_img" src="https://image.flaticon.com/icons/svg/35/35920.svg" title="Positive impact stories for qualitative assessment (2019)"-->
  ...
  <div class="ot_acordion">
                      <!--img class="ot_img" src="https://image.flaticon.com/icons/svg/35/35920.svg" title="Diagnóstico de efetividade de pedidos via LAI e o impacto no controle social (2019)"-->

                      Diagnóstico de efetividade de pedidos via LAI e o impacto no controle social (2019)
                    </div>
                    <div class="ot_txtdrop">
                           <a class="ot_link" title="Diagnóstico de efetividade de pedidos via LAI e o impacto no controle social (2019)" target="_blank" href="https://www.transparencia.org.br/blog/wp-content/uploads/2019/05/Diagnostico_TdP_OT_LAI_2019.pdf"><img class="ot_imgb" src="" title=""></a>
                           <p class="ot_p">Relatório com base em 105 pedidos de acesso a informação feitos a 43 municípios brasileiros aponta que a implementação e efetividade da LAI continuam baixas.
              <br><br>
                     <b class="ot_b">Acesse: <a class="ot_link" title="Diagnóstico de efetividade de pedidos via LAI e o impacto no controle social (2019)" target="_blank" href="https://www.transparencia.org.br/blog/wp-content/uploads/2019/05/Diagnostico_TdP_OT_LAI_2019.pdf">Diagnóstico de efetividade de pedidos via LAI e o impacto no controle social (2019)</a>.</b>
                    </p></div>
  ...
  <div class="ot_acordion">
                      <!--img class="ot_img" src="https://image.flaticon.com/icons/svg/35/35920.svg" title="Monitoramento de obras de escolas e creches financiadas pelo governo federal (2018)"-->
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Controle-Social-de-Obras-Publicas-editc.png" title="Manual de Controle Social de Obras Públicas (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Estudo-Para-Licitacoes.png" title="Material de Referência: Estudo Sobre Licitações (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Estudo-Para-Contratos.png" title="Material de Referência: Estudo Sobre Contratos (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src=" https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Metodos-Detecção-de-Fraude-edit.png" title="Métodos de Detecção de  Fraude e Corrupção em Contratações Públicas (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Guia-1.png" title="Guia 1 - Controle Social de Obras Públicas (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Guia-2.png" title="Guia 2 - Monitorando a contratação de uma obra (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Guia-3.png" title="Guia 3 - Pontos Críticos do Projeto (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Guia-4.png" title="Guia 4 - A execução da obra (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Guia-5.png" title="Guia 5 - Os custos da obra (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Guia-6.png" title="Guia 6 - Fiscalização da Obra (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Guia-7.png" title="Guia 7 - Recebimento da Obra (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Checklists.png" title="Checklists para Controle Social de Obras Públicas (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Checklists-fraudes.png" title="Checklists para Detecção de Fraudes em Licitações (2019)">
      ...
      <div class="ot_bigacordion">
        <img class="ot_img" src="   _imagem_   " title="">
           Análises Técnicas de Licitações 
      </div>
      <div class="ot_bigtxtdrop">
            <div class="ot_envelope"><br>
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Casos-Obra-Transparente-Araucária.png" title="Araucária PR - Análises Técnicas do Projeto Obra Transparente (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Casos-Obra-Transparente-Palhoça.png" title="Palhoça SC - Análises Técnicas do Projeto Obra Transparente (2019)">
...
<div class="ot_acordion">
                    <img class="ot_img" src="https://www.transparencia.org.br/blog/wp-content/uploads/2019/09/capa-Casos-Obra-Transparente-Pelotas.png" title="Pelotas RS - Análises Técnicas do Projeto Obra Transparente (2019)">
...
var acc = document.getElementsByClassName("ot_bigacordion");
  var i;

  for (i = 0; i < acc.length; i++) {
    acc[i].addEventListener("click", function() {
      this.classList.toggle("active");
      var ot_bigtxtdrop = this.nextElementSibling;
      if (ot_bigtxtdrop.style.maxHeight){
        ot_bigtxtdrop.style.maxHeight = null;
      } else {
        ot_bigtxtdrop.setAttribute('style','max-height:'+ot_bigtxtdrop.scrollHeight + '0px!important');
      } 
    });
  }

  var acc = document.getElementsByClassName("ot_acordion");
  var i;

  for (i = 0; i < acc.length; i++) {
    acc[i].addEventListener("click", function() {
      this.classList.toggle("active");
      var ot_txtdrop = this.nextElementSibling;
      if (ot_txtdrop.style.maxHeight){
        ot_txtdrop.style.maxHeight = null;
      } else {
        ot_txtdrop.setAttribute('style','max-height:'+ot_txtdrop.scrollHeight + '0px!important');
      } 
    });
  }
