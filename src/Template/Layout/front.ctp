      ...
      <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
        <div class="container pb-2 pt-3 pr-0">
          ...
          <div class="row new-menu">
            <div class="col-3">
              <a class="navbar-brand pl-1" href="/"><img src="<?= BASE_URL ?>images/logo.png?cache=2" class="d-inline-block logo-image"></a>
            </div>
            <div class="col-lg-9 col-8 pr-0 pt-4">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav menu justify-content-end">
                  ...
                  <a title="Blog" class="nav-item nav-link menu <?= $slug_pai == "blog" ? "ativo" : "" ?>" onclick='registrarEvento("menu_superior","clique","blog")' href="/blog/">Blog</a>
