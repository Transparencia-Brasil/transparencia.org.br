            ...
            <div class="col-lg-9 col-8 pr-0 pt-4">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav menu justify-content-end">
                  ...
                  <a title="Blog" class="nav-item nav-link menu <?= $slug_pai == "blog" ? "ativo" : "" ?>" onclick='registrarEvento("menu_superior","clique","blog")' href="https://www.transparencia.org.br/blog">Blogsss</a>
